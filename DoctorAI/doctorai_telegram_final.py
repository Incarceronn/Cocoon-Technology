# -*- coding: utf-8 -*-
"""DoctorAI_Telegram_Final.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1AIeL0M8jKMoD-JvCKO3kKSR5GcEL1-_n
"""
...
def echo_message(message):
    ...
    if message.text == "/start":
        welcome_message = '''
Welcome to DoctorAI - Your 24/7 Medical Advisor!

We are thrilled to have you join us in this revolutionary healthcare journey. At DoctorAI, our mission is to provide expert medical consultation and support to anyone, anytime, anywhere.

Powered by a state-of-the-art language model enriched with valuable medical knowledge from the NHS under the open government license, we aim to be your trusted companion for all your health-related inquiries.
        '''
